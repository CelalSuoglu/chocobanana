...
-- CreateEnum
CREATE TYPE "FulfillmentStatus" AS ENUM ('NEW', 'PREPARING', 'SHIPPED', 'COMPLETED', 'CANCELED');
...
CREATE TABLE "Order" (
    ...
    "stripeEventIds" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "paymentStatus" "PaymentStatus" NOT NULL DEFAULT 'PAID',
    "fulfillmentStatus" "FulfillmentStatus" NOT NULL DEFAULT 'NEW',
    "amountTotalCadCents" INTEGER NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'cad',
    "presentmentAmountCents" INTEGER,
...
CREATE TABLE "OrderItem" (
    ...
    "unitAmountCadCents" INTEGER NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'cad',
